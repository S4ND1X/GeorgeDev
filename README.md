...
Then I will be migrating the whole frontend to ReactJS and adding backend.

It's not my first time working with React or Web Development in general but when I as learning I didn't have a clear roadmap so this is why I'm starting all over to sharpen those basic skills and have good foundations from HTML, CSS and JS passing through Webpack, Docker, all the way to React, Hooks, NodeJS, SQL, NoSQL and a lot more technologies.
